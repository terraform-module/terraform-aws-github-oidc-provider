...
| <a name="input_authorized_subjects"></a> [authorized\_subjects](#input\_authorized\_subjects) | List of GitHub OIDC subject identifiers authorized to assume the role. | `list(string)` | `[]` | no |
